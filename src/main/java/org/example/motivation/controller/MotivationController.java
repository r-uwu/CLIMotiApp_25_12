...
public class MotivationController {
    ...
    public void create() {
        //Container.getSc().nextLine().trim(); // 버퍼에 남은 엔터때문에 오류나는거 방지용 - trim으로 수정
        System.out.print("motivation : ");
        String moti = Container.getContainer.getSc()().nextLine().trim();

        System.out.print("source : ");
        String source = Container.getContainer.getSc()().nextLine().trim();
    ...
    public void update()
    {
        ...
        int tempNumber = Container.getSc().nextInt();
        Container.getSc().nextLine(); //버퍼 비우는 용도
        ...
        String moti = Container.getSc().nextLine().trim();
